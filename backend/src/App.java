...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        List<Rect> result = Algorithme.FFDH(objetsList);
        System.out.println(result.get(0).getHeightLeft());
        System.out.println(result.get(0).getWidthLeft());
        System.out.println(result.get(0).getLignes());
        System.out.println("Number of bins used: " + result.size());
    }
}
