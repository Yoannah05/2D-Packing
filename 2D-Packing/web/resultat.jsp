<%@ page import="models.Bac" %>
<%@ page import="java.util.List" %>
<%@ page import="models.Objet1D" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%
    List<Bac> bacs = (List<Bac>) request.getAttribute("listeBacs");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="assets/css/resultat.css?v=2">
</head>
<body>
<h1 class="h1 text-center m-4">Resultat 1D Packing</h1>
<form method="get" action="OnedServlet" class="row w-50 g-3 p-3 needs-validation" novalidate>
    <div class="col-12">
...
<div class="container">
    <%for (Bac b : bacs) { %>
    <div class="bac" style="width: <%= Bac.getWidth() %>px;">
        <%for (Objet1D o : b.getObjets()) {%>
        <div class="objet"
             style="background-color:<%= o.getColor() %>; width: <%= o.getWidth() %>px;">
            <%= o.getId_obj() %>
        </div>
        <% } %>
    </div>
