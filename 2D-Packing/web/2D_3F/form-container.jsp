...
<body>
    <div class="container">
        ...
        <form id="form" action="3Forme?forme=container" method="post" class="row g-3 needs-validation" novalidate>
            <h1 class="h1 text-center">2D Packing, 3 formes</h1>
            <div class="col-12">
                <label for="container" class="form-label">Width</label>
                <input type="number" name="width" class="form-control" id="container"  required>
