...
<body>
    <div class="container">
        ...
        <div class="col-5 mb-4">
            <label for="nbrObjet" class="form-label">Combien de triangle voulez-vous inserer ?</label>
            <input type="number" class="form-control" id="nbrObjet" required>
            <div class="valid-feedback"></div>
        </div>
        
        <form id="form" action="3Forme?forme=triangle" method="post" class="row g-3 needs-validation" novalidate></form>
    </div>
                ...
                let formContent = `<h1 class="h1 text-center">2D Packing, 3 formes</h1>`;
                    ...
                    if (nbr.value !== "") {
                        for (let i = 1; i <= nbr.value; i++) {
                            ...
                            <div class="col-12">
                                <label for="base`+i +`" class="form-label">Base du triangle`+i +`</label>
                                <input type="number" name="base`+i + `" class="form-control" id="base`+i + `"  required>
                                <div class="valid-feedback"></div>
                            </div>
                            <div class="col-12">
                                <label for="Height`+i +`" class="form-label">Hauteur du triangle`+i +`</label>
                                <input type="number" name="height`+i +`" class="form-control" id="Height`+i +`"  required>
                                <div class="valid-feedback"></div>
                            </div><hr>`;
                        }
                    }
