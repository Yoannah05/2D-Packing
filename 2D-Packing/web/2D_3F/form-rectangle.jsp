...
<body>
    <div class="container">
        ...
        <div class="col-5 mb-4">
            <label for="nbrObjet" class="form-label">Combien de rectanlge voulez-vous inserer ?</label>
            <input type="number" class="form-control" id="nbrObjet" required>
            <div class="valid-feedback"></div>
        </div>
        
        <form id="form" action="3Forme?forme=rectangle" method="post" class="row g-3 needs-validation" novalidate></form>
    </div>
